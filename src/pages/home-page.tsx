    ...
    <div className="space-y-16">
      ...
      <section className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-brand-700 via-brand-600 to-brand-500 px-8 py-16 text-white shadow-xl">
        ...
        <div className="relative mx-auto max-w-3xl text-center">
          ...
          <div className="mt-8 flex flex-wrap justify-center gap-3">
            <Link
              to="/demo-web"
              className="inline-flex items-center gap-2 rounded-xl bg-white px-5 py-2.5 text-sm font-bold text-brand-700 shadow transition hover:bg-brand-50"
            >
      ...
      <section className="space-y-6">
        <div className="text-center">
          <h2 className="text-3xl font-bold text-slate-900">Todo lo que necesitas en una plataforma</h2>
          <p className="mt-2 text-slate-500">Automatización, omnicanalidad y analítica para COMFAGUAJIRA</p>
        </div>
      ...
      <section className="rounded-3xl bg-slate-50 px-8 py-12">
        <div className="mb-10 text-center">
          ...
          <p className="mt-2 text-slate-500">En segundos, el afiliado obtiene respuesta</p>
        </div>
        <div className="relative grid gap-8 md:grid-cols-3">
          <div className="absolute left-1/2 top-8 hidden h-0.5 w-2/3 -translate-x-1/2 bg-brand-200 md:block" />
          {steps.map((step) => (
            <div key={step.number} className="relative flex flex-col items-center text-center">
              <div className="relative z-10 mb-4 flex h-16 w-16 items-center justify-center rounded-full bg-brand-600 text-white shadow-lg">
                <step.icon size={24} />
                <span className="absolute -right-1 -top-1 flex h-6 w-6 items-center justify-center rounded-full bg-white text-xs font-bold text-brand-700 shadow">
                  {step.number}
                </span>
              </div>
      ...
      <section className="rounded-2xl bg-gradient-to-r from-brand-600 to-brand-500 px-8 py-10 text-center text-white shadow">
        ...
        <div className="mt-6 flex flex-wrap justify-center gap-4">
          <Link
            to="/demo-web"
            className="inline-flex items-center gap-2 rounded-xl bg-white px-6 py-3 text-sm font-bold text-brand-700 shadow transition hover:bg-brand-50"
          >
            Probar Demo Web <ArrowRight size={16} />
          </Link>
          <Link
