  ...
  return (
    <div className="p-4 sm:p-6 max-w-7xl mx-auto">
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4 min-h-[72vh]">
        <aside className="lg:col-span-3 rounded-xl border border-ink-200 bg-white p-4">
        ...
        <section className="lg:col-span-9 rounded-xl border border-ink-200 bg-white p-4 flex flex-col">
