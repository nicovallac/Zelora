...
const flowSteps = [
  ...
  { label: 'IA detecta\nintención', icon: '🤖', color: 'bg-brand-600 text-white', border: 'border-brand-500' },
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <h2 className="mb-3 text-lg font-bold text-slate-900">¿Cómo funciona la captación en TikTok?</h2>
        <div className="grid gap-4 text-sm text-slate-600 md:grid-cols-3">
          <div className="rounded-xl bg-slate-50 p-4">
            <p className="mb-1 font-bold text-slate-900">1. Comentario en video</p>
            Un afiliado comenta en un video de COMFAGUAJIRA pidiendo información. El bot detecta el @mention y responde públicamente.
          </div>
          <div className="rounded-xl bg-slate-50 p-4">
            <p className="mb-1 font-bold text-slate-900">2. DM automático</p>
            Simultáneamente envía un DM privado con más información y un enlace al chat web o WhatsApp para continuar la atención.
          </div>
          <div className="rounded-xl bg-slate-50 p-4">
            <p className="mb-1 font-bold text-slate-900">3. Conversión</p>
      ...
      <div className="grid gap-6 lg:grid-cols-2">
        ...
        <div className="space-y-4">
          <h3 className="font-bold text-slate-900">Video en TikTok + comentario bot</h3>
            ...
            <div className="relative flex h-72 items-center justify-center bg-gradient-to-br from-slate-800 to-slate-950">
              ...
              <div className="absolute inset-0 flex items-center justify-center">
                <div className="text-center">
                  ...
                  <p className="mt-1 text-xs text-slate-400">💰 ¿Sabías que tienes subsidio familiar?</p>
                  <p className="text-xs text-slate-400">Afíliate hoy y empieza a cobrar 👇</p>
                </div>
              </div>
              ...
              <div className="absolute bottom-4 left-3 right-16">
                ...
                <p className="text-xs text-slate-400">#subsidio #comfaguajira #guajira #beneficios</p>
              </div>
            </div>
              ...
              <div className="flex gap-2">
                ...
                <div>
                  <p className="text-xs">
                    ...
                    <span className="text-slate-300">¿Cómo aplico para el subsidio? @comfaguajira</span>
                  </p>
                  <p className="text-[10px] text-slate-500">hace 2h · 47 likes</p>
                </div>
              </div>
              ...
              <div className="flex gap-2 rounded-lg bg-white/5 p-2">
                ...
                <div>
                  <p className="text-xs">
                    ...
                    <span className="text-slate-300">¡Hola! Te mandamos un DM con toda la info 😊 ¡Es muy fácil afiliarse!</span>
                  </p>
                  <p className="text-[10px] text-slate-500">hace 2h · Respuesta automática · 12 likes</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="space-y-4">
          <div className="flex items-center justify-between">
            <h3 className="font-bold text-slate-900">DM resultante</h3>
          ...
          <div className="overflow-hidden rounded-2xl border border-slate-800 bg-slate-950 shadow-xl">
            ...
            <div className="flex items-center gap-3 border-b border-white/10 bg-slate-900 px-4 py-3">
              ...
              <div>
                ...
                <p className="text-xs text-slate-400">Mensaje directo</p>
              </div>
            </div>
              ...
              {dmMessages.map((msg) => (
                <div key={msg.id} className={`flex ${msg.role === 'user' ? 'justify-start' : 'justify-end'}`}>
                  ...
                  >
                    ...
                    <p className={`mt-1 text-right text-[10px] ${msg.role === 'user' ? 'text-slate-400' : 'text-white/70'}`}>
                      {msg.time}
                    </p>
                  </div>
                </div>
            ...
            <div className="border-t border-white/10 bg-slate-900 p-4 space-y-2">
              <p className="text-xs font-semibold text-slate-400">Continuar atención en:</p>
              <div className="flex gap-2">
                ...
                <button className="flex flex-1 items-center justify-center gap-1.5 rounded-xl bg-brand-600 py-2.5 text-xs font-bold text-white transition hover:bg-brand-700">
      ...
      {/* Flow diagram */}
      <div className="rounded-2xl border border-slate-200 bg-white p-6">
        <h3 className="mb-6 text-center font-bold text-slate-900">Flujo de captación TikTok → Conversión</h3>
