...
export function CustomerMemoryPanel({
  ...
  return (
    <aside className="fixed inset-0 z-40">
      ...
      <div className="absolute right-0 top-0 h-full w-full max-w-xl bg-white/70 backdrop-blur-sm border-l border-[rgba(17,17,16,0.10)] overflow-y-auto p-4 sm:p-5">
        ...
        <div className="mt-4 rounded-lg border border-[rgba(17,17,16,0.10)] p-3">
