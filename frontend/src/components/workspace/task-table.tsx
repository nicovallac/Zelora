...
export function TaskTable({
  ...
  return (
    <div className="rounded-xl border border-[rgba(17,17,16,0.10)] bg-white/70 backdrop-blur-sm overflow-x-auto">
      <table className="w-full min-w-[820px] text-sm">
        ...
        <tbody>
          {tasks.map((task) => (
            <tr key={task.id} className="border-t border-[rgba(17,17,16,0.08)]">
              ...
              <td className="px-3 py-3">
                <select
                  ...
                  className="rounded-md border border-[rgba(17,17,16,0.10)] bg-white/70 backdrop-blur-sm px-2 py-1 text-xs"
                >
