...
export function DecisionCard({
  ...
  return (
    <article className="rounded-xl border border-[rgba(17,17,16,0.10)] bg-white/70 backdrop-blur-sm p-4">
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        <button onClick={() => onConvertTask(decision.id)} className="rounded-md bg-brand-500 px-2.5 py-1.5 text-[11px] text-white font-semibold">
          Convert to task
        </button>
