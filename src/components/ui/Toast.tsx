...
function ToastItem({ toast }: { toast: Toast }) {
  ...
  return (
    <motion.div
      ...
      className={`relative w-80 overflow-hidden rounded-xl border shadow-lg ${cfg.bg} ${cfg.border}`}
    >
      <div className="flex items-start gap-3 p-4">
        ...
        <button
          ...
          className={`flex-shrink-0 rounded-md p-0.5 transition hover:opacity-70 ${cfg.text}`}
        >
          <X size={14} />
        </button>
      </div>
